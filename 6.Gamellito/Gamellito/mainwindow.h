...
private slots:
    ...
    /**
     * @brief Atualiza o botão com o ícone de salvar
     * @param botao O endereço do botão a mudar o ícone
     */
    void atualizarIconeSalvar(QPushButton *botao);

    /**
     * @brief Atualiza o botão com o ícone de próximo
     * @param botao O endereço do botão a mudar o ícone
     */
    void atualizarIconeProximo(QPushButton *botao);

    /**
     * @brief Atualiza o estilo do seletor de uma pergunta
     * @param opcao O endereço do seletor
     * @param estiloFundo O estilo que será aplicado no fundo do seletor
     */
    void atualizarEstiloSeletor(QRadioButton *seletor, QString estiloFundo);
...
private:
    ...
    QTimer *contador;
    int tempoOcioso = 2 * 60 * 1000; // Em milissegundos
    bool ocioso = false;
