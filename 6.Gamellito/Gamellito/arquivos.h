...
public:
     ...
     */
    static QFile *abrirArquivoEscrita(QString pathArquivo);
     ...
     * @return O endereço do arquivo, ou nulo caso haja erro
     */
    static QFile *abrirArquivoLeitura(QString pathArquivo);

    /**
     * @brief Fecha o arquivo aberto
     * @param arquivo O endereço do arquivo aberto
     */
    static void fecharArquivo(QFile *arquivo);
    ...
    /**
     * @brief Carrega uma propriedade de um objeto Json que está em um arquivo
     * @param pathArquivo O caminho completo do arquivo
     * @param propriedade A propriedade a ser carregada
