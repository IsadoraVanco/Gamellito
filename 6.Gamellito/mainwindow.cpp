...
//    ui->pushButton_configurar->setIcon(QIcon("assets/icones/configuracoes/configuracoes.png"));
//    ui->pushButton_iniciar->setIcon(QIcon("assets/botoes/menu/iniciar.png"));
...
void MainWindow::configurarElementosTelaPergunta(){
    // Opções da pergunta
    QString estiloPergunta = "QRadioButton{ border-image: none; font-size:24px; font-weight: bold; background-color: #ffbe33;"
                            "border: 3px solid  #4466c3; border-radius: 10px; min-width: 220px; min-height: 60px; padding: 7px;}"
                            "QRadioButton::indicator{ width: 25 px; height: 25 px; margin: 0;}"
...
//    QIcon salvar("assets/icones/salvar/salvar.png");
...
void MainWindow::adicionarIconesPaginaInicial(){
    QString estilo = "QPushButton {border-image: url(':/icones/assets/icones/pagina-inicial/pagina-inicial.png');}"
                    "QPushButton:hover {border-image: url(':/icones/assets/icones/pagina-inicial/pagina-inicial-hover.png');}"
                    "QPushButton:pressed {border-image: url(':/icones/assets/icones/pagina-inicial/pagina-inicial-hover.png');}";

    ui->pushButton_inicio_configurar->setStyleSheet(estilo);
    ui->pushButton_inicio_configurar_perfil->setStyleSheet(estilo);
    ui->pushButton_inicio_reprodutor->setStyleSheet(estilo);
    ui->pushButton_inicio_pergunta->setStyleSheet(estilo);
    ui->pushButton_inicio_editar_pergunta->setStyleSheet(estilo);
    ui->pushButton_inicio_adicionar_pergunta->setStyleSheet(estilo);
}
...
void MainWindow::mostrarRespostaCorreta(){
    ...
    // Errada
    QString estilo = "QRadioButton{ border-image: none; font-size:24px; font-weight: bold; background-color: #ff422b;"
                       "border: 3px solid  #4466c3; border-radius: 10px; min-width: 220px; min-height: 60px; padding: 7px;}"
                     "QRadioButton::indicator{ width: 25 px; height: 25 px; margin: 0;}"
    ...
    if(correta == respondida){
        estilo = "QRadioButton{ border-image: none; font-size:24px; font-weight: bold; background-color: #4cff2b;"
                    "border: 3px solid  #4466c3; border-radius: 10px; min-width: 220px; min-height: 60px; padding: 7px;}"
                 "QRadioButton::indicator{ width: 25 px; height: 25 px; margin: 0;}"
